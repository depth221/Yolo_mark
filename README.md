...
<kbd>0-9</kbd> | Object id, change object id (hovered on a rect) ☆|
<kbd>SHIFT</kbd> + <kbd>0-9</kbd> | Object id (over 1-order), change object id (hovered on a rect) ☆|
